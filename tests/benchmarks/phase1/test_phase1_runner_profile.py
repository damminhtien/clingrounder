...
""",
    ...
    assert config.terminology.recognition_dictionary_path == str(tmp_path / "seed.jsonl")
    assert config.terminology.abbreviation_path == str(tmp_path / "abbr.jsonl")
    assert config.terminology.additional_recognition_dictionary_paths == (
        str(tmp_path / "mined-a.jsonl"),
        str(tmp_path / "mined-b.jsonl"),
    )
    assert config.terminology.normalization_dictionary_paths == (str(tmp_path / "icd.jsonl"),)
