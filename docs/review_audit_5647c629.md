...
| 3 | The full profile omitted full ICD-10 VN | Fixed | `configs/benchmarks/phase1/submission/full.yaml` loads full TT06 ICD-10 VN and RxNorm July 6, 2026 as normalization sources. Release tests query both repositories directly. |
