...
uv run clingrounder-research data label propose \
  ...
  --adapter clingrounder.mining.labelers.pipeline:create_local_pipeline_labeler \
...
uv run clingrounder-research data dataset attach-block-evidence \
  --documents outputs/mining/pmc-rare-cases-ccby-2026-07-19/documents_v2.jsonl \
...
uv run clingrounder-research data knowledge compile-recognition \
