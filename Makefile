.PHONY: install install-dev pre-commit lint type test test-fast test-full test-all test-targeted validate pipeline evaluate profile benchmark-phase1-submit benchmark-phase1-validate ablation qa qa-full clean
