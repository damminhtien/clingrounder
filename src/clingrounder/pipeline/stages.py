"""Typed execution stages used by :mod:`clingrounder.pipeline.runner`.
...
from clingrounder.kg.validator import ValidationIssue
...
from clingrounder.schema.document import ClinicalDocument, Section, Sentence
...
from clingrounder.utils.text import text_window
from clingrounder.linking.batch import (
