...
from clingrounder.governance import GovernancePolicy, fingerprint_artifact, safe_artifact_path, verify_artifact
from clingrounder.governance.audit import AuditEvent, InMemoryAuditSink
...
from clingrounder.pipeline.builders import (
    build_entity_extractor,
    build_graph_repository,
    build_linking,
    build_terminology,
)
from clingrounder.pipeline.config_schema import validate_pipeline_mapping
from clingrounder.pipeline.model_config import PipelineModelConfig
from clingrounder.pipeline.options import PipelineOptions
from clingrounder.pipeline.runner import PipelineRunner
from clingrounder.pipeline.runtime import Closable, PipelineRuntime
...
class TerminologyConfig:
    ...
    terminology_cache_dir: str = ".cache/clingrounder/terminology"
