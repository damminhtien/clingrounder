...
from clingrounder.benchmarks.plugins import BenchmarkHandler

__all__ = ["PHASE1_PLUGIN", "Phase1BenchmarkPlugin"]

_COMMAND_MODULE = "clingrounder.benchmarks.phase1.commands"
_HANDLER_FUNCTIONS = {
...
class Phase1BenchmarkPlugin:
    ...
    def register_cli(
        ...
        from clingrounder.benchmarks.phase1.cli import register_phase1_cli
