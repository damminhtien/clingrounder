...
from clingrounder.benchmarks.phase1.phase1 import _match_phase1_rows
from clingrounder.benchmarks.phase1.ontology import PHASE1_ASSERTABLE_TYPES, PHASE1_CODABLE_TYPES
...
def evaluate_manual_gold(
    ...
    from clingrounder.benchmarks.phase1.phase1 import score_phase1_documents
