...
from clingrounder.kg.knowledge_schema import KnowledgeNeighbor
from clingrounder.kg.ports import KnowledgeGraphRepositoryPort
from clingrounder.linking.candidate import Candidate, CandidateEvidence
from clingrounder.schema.types import CodeSystem

if TYPE_CHECKING:
    from clingrounder.pipeline.ports import CandidateRerankerPort
