...
from clingrounder.adapters.huggingface.runtime import (
    _as_nested_list,
    _load_runtime,
    _probability,
    _slice_model_inputs,
)
from clingrounder.adapters.model_spans import TokenPrediction, project_bio_predictions
...
class HuggingFaceTokenClassifierAdapter:
    ...
    def close(self) -> None:
        """Release the lazy model/tokenizer runtime if it was loaded."""
