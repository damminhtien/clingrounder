...
from clingrounder.schema.output import ClinicalPrediction, PredictionMetadata
from clingrounder.schema.types import AssertionStatus, CodeSystem, EntityType, RelationType

if TYPE_CHECKING:
    from clingrounder.schema.validator import (
...
def __getattr__(name: str) -> Any:
    if name in {"PredictionValidationIssue", "PredictionValidator", "prediction_from_json"}:
        from clingrounder.schema import validator
