...
class PublicRepositoryPolicy(BaseModel):
    ...
    schema_version: Literal["clingrounder.public-repository-policy.v1"]
...
class PublicReleaseReport(BaseModel):
    ...
    schema_version: Literal["clingrounder.public-release-report.v1"]
    valid: bool
    policy_path: str
...
class LocalArtifactInventory(BaseModel):
    ...
    schema_version: Literal["clingrounder.local-artifact-inventory.v1"]
    policy_path: str
...
def audit_public_repository(
    ...
    *,
    ...
    return PublicReleaseReport(
        schema_version="clingrounder.public-release-report.v1",
...
def build_local_artifact_inventory(
    ...
    return LocalArtifactInventory(
        schema_version="clingrounder.local-artifact-inventory.v1",
        policy_path=_display_path(policy_source, repository_root),
