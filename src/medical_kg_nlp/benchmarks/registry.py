...
from medical_kg_nlp.benchmarks.plugins import BenchmarkHandler, BenchmarkPlugin
...
BENCHMARK_ENTRY_POINT_GROUP = "medical_kg_nlp.benchmarks"


def benchmark_plugins() -> tuple[BenchmarkPlugin, ...]:
    """Load built-in and installed plugins in deterministic name order."""

    from medical_kg_nlp.benchmarks.phase1.plugin import PHASE1_PLUGIN
