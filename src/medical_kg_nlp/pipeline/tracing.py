...
class OpenTelemetryPipelineObserver:
    ...
    def __init__(self, tracer: Any = None, meter: Any = None) -> None:
        ...
        self._tracer = tracer or trace.get_tracer("medical_kg_nlp")
        self._meter = meter or metrics.get_meter("medical_kg_nlp")
        self._stage_latency = self._meter.create_histogram("medical_kg.pipeline.stage_ms")
        self._counter = self._meter.create_counter("medical_kg.pipeline.events")
